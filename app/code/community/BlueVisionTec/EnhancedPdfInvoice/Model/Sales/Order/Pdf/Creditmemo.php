 ...
 */
class BlueVisionTec_EnhancedPdfInvoice_Model_Sales_Order_Pdf_Creditmemo extends Mage_Sales_Model_Order_Pdf_Creditmemo
{
  /**
  ...
  public function getPdf($creditmemos = array())
  {
      ...
      foreach ($creditmemos as $creditmemo) {
          ...
          $this->insertDocumentNumber(
              $page,
              Mage::helper('sales')->__('Credit Memo # ') 
          ...
          if(Mage::getStoreConfig(
            ...
            $this->y -= 15;
            $this->_insertTaxBox($page, $creditmemo);
          }
          ...
          $this->_insertFooterText($page, $creditmemo->getStore());         
  ...
  */
  ...
  protected function _insertOrderHead(&$page, $obj, $oInvoice, $putOrderId = true)
  {
      ...
      $page->drawText(
              Mage::helper('sales')->__('Credit Memo'), $this->_iLeftMargin, $this->y, 'UTF-8'
          );
      ...
      if($oInvoice !== null)
      {
        $sInvoiceNumber =  Mage::helper('sales')->__('Credit Memo # ').$oInvoice->getIncrementId();
      ...
      $sinvoiceDate = Mage::helper('sales')->__('Creditmemo Date: ') . Mage::helper('core')->formatDate(
